...
var gulpSrcPath     = "src/";
var libsPath        = "libs/";
var bowerLibsPath   = "libs/bower_libs/";
var distPath        = "dist/";
...
gulp.task('files-libs', function() {
    var fontsFiles =  gulp.src([
        bowerLibsPath + 'bootstrap/fonts/*'
    ])
        .pipe(gulp.dest(gulpSrcPath + 'fonts'))

    var sassFiles =  gulp.src([
        bowerLibsPath + 'sass-mediaqueries/_media-queries.scss'
    ])
...
gulp.task('watch', ['browser-sync-proxy', 'js-libs', 'css-libs', 'files-libs', 'common-js-dist', 'common-css-dist', 'dist'], function () {
